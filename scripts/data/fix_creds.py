...
# Costruiamo il dizionario esattamente
creds = {
...
target_path = os.path.join(os.getcwd(), "scripts/data/nuzantara_key.json")
with open(target_path, "w") as f:
    json.dump(creds, f, indent=2)

print(f"✅ File {target_path} rigenerato con successo e validato.")
