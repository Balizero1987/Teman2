...
TARGET_FILE = "/Users/antonellosiano/Desktop/visa_oracle_export.json"
...
def fetch_all_points(collection_name):
    ...
    while True:
        try:
            ...
            print(f"Fetched {len(batch_points)} points...")
...
def save_to_desktop(points):
    try:
        # Extract just the payload and id for cleaner output
        data = []
        for p in points:
