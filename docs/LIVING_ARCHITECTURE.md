...
#### `GET /debug/parent-documents/{document_id}`

Get parent documents (BAB) from PostgreSQL

**File:** `app/api/debug.py`

---

#### `GET /debug/parent-documents/{document_id}/{bab_id}`
...
#### `GET /api/feedback/ratings/{session_id}`
...
#### `POST /api/feedback/rate-conversation`
...
**Response Model:** `RateConversationResponse`
...
#### `services.context.agentic_orchestrator_v2`
