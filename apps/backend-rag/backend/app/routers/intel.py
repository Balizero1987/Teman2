...
class ScraperSubmission(BaseModel):
    ...
    cover_image: str = Field(..., description="Cover image URL/path generated by Claude (mandatory)")
...
async def submit_from_scraper(submission: ScraperSubmission):
    ...
    try:
        ...
        if not submission.cover_image:
            raise ValueError("cover_image is mandatory but not provided")
