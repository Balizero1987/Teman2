# E33G Digital Nomad Visa — Full Conversation (Basic)

> **Generated**: 2025-12-10
> **Topics Covered**: E33G Digital Nomad KITAS, 30-day stay, No work requirement, Multiple entry, Costs, Requirements, Remote work legality, Extension process
> **Style**: Anxious first-timer, basic questions
...
**1 — Client:**
Halo, saya dengar ada visa khusus untuk digital nomad di Indonesia sekarang. Saya kerja remote untuk company di Singapura. Visa apa yang cocok?
...
Yang dilihat: konsistensi income, bukan one-time deposit.

**4 — Client:**
Saya freelance, ada beberapa client. Gimana cara buktiin income?
...
**6 — Client:**
Kalau saya apply offshore, gimana prosesnya?

**Consultant:**
**Offshore Process:**

1. **Prepare documents** → kirim ke kita
2. **Apply evisa** → kita submit ke sistem imigrasi Indonesia
3. **Get approval** → evisa keluar (PDF)
4. **Fly to Indonesia** → tunjukkan evisa di airport
5. **Immigration processing** → fingerprint, photo di airport
6. **KITAS delivered** → physical card dikirim ke alamat kamu (~7-10 hari)

Total time: **7-14 hari kerja** dari submit dokumen sampai approval.

**7 — Client:**
Saya harus ke embassy dulu nggak?
...
Semua digital. Kamu apply, dapat approval PDF, langsung terbang ke Indonesia.

**8 — Client:**
Kalau sudah di Indonesia, saya bebas kerja remote kan?
...
- ❌ Provide services ke client Indonesia (grey area)

**9 — Client:**
Kalau client saya ada yang dari Indonesia gimana?
...
**10 — Client:**
Saya baca ada "30-day stay limit" — itu artinya apa?
...
3. **Obey visa terms**
   - Tidak kerja untuk perusahaan lokal
   - Maintain income requirement

**No tax obligation** (selama income dari luar + transferred ke rekening luar).

**12 — Client:**
SKTT reporting itu ribet nggak?

**Consultant:**
**Cukup simple:**

1. Datang ke **immigration office** sesuai domisili kamu
2. Bawa **KITAS** asli + fotokopi
3. Bawa **KK** (Kartu Keluarga) atau surat sewa rumah
4. Isi form, antri 10-30 menit
...
- **Denda administratif** (varies by kantor, ~Rp 300K - 1jt)
- **Susah extend KITAS** (harus clear dulu)
- **Warning letter** dari imigrasi
...
**15 — Client:**
Kalau nanti saya mau switch ke visa lain gimana?

**Consultant:**
**Bisa switch** ke:

1. **E28A Investor KITAS**
   - Kalau kamu buka PT PMA (company sendiri)
   - Process: setup PT → apply E28A
   - **No need exit Indonesia**

2. **E26 Spouse KITAS**
   - Kalau menikah dengan WNI (Indonesian citizen)
   - Validity 2 tahun, cheaper

3. **KITAP** (Permanent Residence)
   - Setelah hold KITAS **4-5 tahun** consecutive
...
**16 — Client:**
Soal pajak — saya nggak perlu bayar tax Indonesia kan?
...
**17 — Client:**
Saya dari US, ada tax treaty US-Indonesia?
...
**18 — Client:**
Kalau saya mau apply, apa langkah pertama?
...
**19 — Client:**
Oke, biaya totalnya berapa dari awal sampai selesai?
...
**Consultant:**
Kirim semua dokumen ke:

📧 **Email:** docs@balizero.com
💬 **WhatsApp:** +62-xxx-xxx-xxxx (link di website)
...
Kita review dalam **24 jam** dan confirm next steps.

Welcome to Indonesia — see you in Bali soon! 🌴
...
**1 — Client:**
Hi, I heard there's a special visa for digital nomads in Indonesia now. I work remotely for a Singapore company. Which visa is suitable?
...
What matters: **income consistency**, not one-time deposits.

**4 — Client:**
I'm a freelancer with multiple clients. How do I prove income?
...
**6 — Client:**
If I apply offshore, what's the process?

**Consultant:**
**Offshore Process:**

1. **Prepare documents** → send to us
2. **Apply evisa** → we submit to Indonesian immigration system
3. **Get approval** → evisa issued (PDF)
4. **Fly to Indonesia** → show evisa at airport
5. **Immigration processing** → fingerprint, photo at airport
6. **KITAS delivered** → physical card sent to your address (~7-10 days)

Total time: **7-14 working days** from document submission to approval.

**7 — Client:**
Do I need to visit the embassy first?
...
All digital. You apply, get approval PDF, fly directly to Indonesia.

**8 — Client:**
Once in Indonesia, I'm free to work remotely, right?
...
- ❌ Provide services to Indonesian clients (grey area)

**9 — Client:**
What if some of my clients are from Indonesia?
...
**10 — Client:**
I read about a "30-day stay limit" — what does that mean?
...
3. **Obey visa terms**
   - Don't work for local companies
   - Maintain income requirement

**No tax obligation** (as long as income from abroad + transferred to foreign account).

**12 — Client:**
Is SKTT reporting complicated?

**Consultant:**
**Quite simple:**

1. Go to **immigration office** in your domicile area
2. Bring **KITAS** original + photocopy
3. Bring **KK** (Family Card) or rental agreement
4. Fill form, queue 10-30 minutes
...
- **Administrative fine** (varies by office, ~IDR 300K - 1M)
- **Difficulty extending KITAS** (must clear first)
- **Warning letter** from immigration
...
**15 — Client:**
If I want to switch to another visa later, how?

**Consultant:**
**Can switch** to:

1. **E28A Investor KITAS**
   - If you establish PT PMA (own company)
   - Process: setup PT → apply E28A
   - **No need to exit Indonesia**

2. **E26 Spouse KITAS**
   - If married to Indonesian citizen
   - 2-year validity, cheaper

3. **KITAP** (Permanent Residence)
   - After holding KITAS **4-5 years** consecutively
   - Apply for permanent stay
...
**16 — Client:**
About taxes — I don't need to pay Indonesian tax, right?
...
**17 — Client:**
I'm from the US, is there a US-Indonesia tax treaty?
...
**18 — Client:**
If I want to apply, what's the first step?
...
**19 — Client:**
Okay, what's the total cost from start to finish?
...
📧 **Email:** docs@balizero.com
💬 **WhatsApp:** +62-xxx-xxx-xxxx (link on website)
...
We'll review within **24 hours** and confirm next steps.
...
**1 — Client:**
Mas, aku krungu ono visa khusus kanggo digital nomad neng Indonesia saiki. Aku kerjo remote kanggo company neng Singapura. Visa opo sing cocok?
...
Sing diliat: konsistensi income, dudu one-time deposit.

**4 — Client:**
Aku freelance, ono sawetara client. Piye carane buktiin income?
...
**6 — Client:**
Nek aku apply offshore, piye prosesne?

**Consultant:**
**Offshore Process:**

1. **Prepare documents** → kirim neng kito
2. **Apply evisa** → kito submit neng sistem imigrasi Indonesia
3. **Get approval** → evisa metu (PDF)
4. **Fly to Indonesia** → tunjukke evisa neng airport
5. **Immigration processing** → fingerprint, foto neng airport
6. **KITAS delivered** → physical card dikirim neng alamat sampeyan (~7-10 dino)

Total time: **7-14 dino kerjo** soko submit dokumen sampek approval.

**7 — Client:**
Aku kudu neng embassy dhisik ora?
...
Kabeh digital. Sampeyan apply, entuk approval PDF, langsung mabur neng Indonesia.

**8 — Client:**
Nek wis neng Indonesia, aku bebas kerjo remote kan?
...
- ❌ Buka kantor/recruit staff lokal
- ❌ Provide services neng client Indonesia (grey area)

**9 — Client:**
Nek client ku ono sing soko Indonesia piye?
...
**10 — Client:**
Aku moco ono "30-day stay limit" — iku artine opo?
...
3. **Obey visa terms**
   - Ora kerjo kanggo perusahaan lokal
   - Maintain income requirement

**Ora ono tax obligation** (salawase income soko luar + transferred neng rekening luar).

**12 — Client:**
SKTT reporting iku ribet ora?

**Consultant:**
**Cukup simple:**

1. Teko neng **immigration office** sesuai domisili sampeyan
2. Gowo **KITAS** asli + fotokopi
3. Gowo **KK** (Kartu Keluarga) utowo surat sewa omah
4. Isi form, antri 10-30 menit
...
- **Denda administratif** (varies by kantor, ~Rp 300K - 1jt)
- **Susah extend KITAS** (kudu clear dhisik)
- **Warning letter** soko imigrasi
...
**15 — Client:**
Nek mengko aku arep switch neng visa liyo piye?

**Consultant:**
**Iso switch** neng:

1. **E28A Investor KITAS**
   - Nek sampeyan buka PT PMA (company dewe)
   - Process: setup PT → apply E28A
   - **Ora usah exit Indonesia**

2. **E26 Spouse KITAS**
   - Nek nikah karo WNI (Indonesian citizen)
   - Validity 2 taun, luwih murah

3. **KITAP** (Permanent Residence)
   - Sakwise hold KITAS **4-5 taun** consecutive
   - Apply for permanent stay
...
**16 — Client:**
Soal pajak — aku ora usah bayar tax Indonesia kan?
...
**17 — Client:**
Aku soko US, ono tax treaty US-Indonesia?
...
**18 — Client:**
Nek aku arep apply, opo langkah pertama?
...
**19 — Client:**
Oke, biaya totale piro soko awal sampek rampung?
...
**Consultant:**
Kirim kabeh dokumen neng:

📧 **Email:** docs@balizero.com
💬 **WhatsApp:** +62-xxx-xxx-xxxx (link neng website)
...
3. Employment letter/contract
4. Bank statements (3 sasi)
5. Insurance proof
6. CV

Kito review dalam **24 jam** lan confirm next steps.

Welcome to Indonesia — ketemu neng Bali sesuk! 🌴
