...
class TestAgenticRAGSessionAPI:
    ...
    def test_greeting_endpoint_skips_rag(self, authenticated_client, mock_orchestrator):
        ...
        with patch("backend.app.routers.agentic_rag.get_orchestrator") as mock_get:
            ...
            response = authenticated_client.post(
                ...
                json={"query": "ciao", "user_id": "test@example.com", "session_id": str(uuid4())},
            )
    ...
    def test_different_sessions_get_different_contexts(
        self, authenticated_client, mock_orchestrator
    ):
