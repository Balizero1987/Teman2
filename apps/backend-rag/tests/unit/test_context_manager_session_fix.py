...
class TestContextManagerSessionFiltering:
    ...
    def mock_memory_orchestrator(self):
        ...
        orchestrator.get_user_context = AsyncMock(return_value=MagicMock(
            profile_facts=[],
            collective_facts=[],
            timeline_summary="",
            kg_entities=[],
    ...
    @pytest.mark.asyncio
    async def test_no_session_id_uses_latest_conversation(self, mock_db_pool, mock_memory_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_non_empty_history_loads_memory_facts(self, mock_db_pool, mock_memory_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_anonymous_user_returns_empty_context(self, mock_db_pool, mock_memory_orchestrator):
