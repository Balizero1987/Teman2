              ...
              <div className="col-span-12 lg:col-span-4 flex flex-col gap-3">
                ...
                <div className="py-8 lg:py-12 relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    <Image
                      src="/static/indonesian-flag-drape.jpg"
                      alt=""
                      fill
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="group relative rounded-xl overflow-hidden">
                <div className="aspect-video relative">
                  <Image src="/static/blog/golden-visa.jpg" alt="Video thumbnail" fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
...
const MOCK_ARTICLES: ArticleListItem[] = [
  {
    ...
    category: 'tax-legal',
    author: { id: 'editorial', name: 'Bali Zero Editorial', avatar: '/images/team/editorial.jpg', role: 'Editorial', isAI: false },
  ...
  },
  {
    ...
    coverImage: '/images/news/coretax-kpp-queue.jpg',
    category: 'tax-legal',
    author: { id: 'editorial', name: 'Bali Zero Editorial', avatar: '/images/team/editorial.jpg', role: 'Editorial', isAI: false },
  ...
  },
  {
    ...
    coverImage: '/images/news/gemini-3-ai.jpg',
    category: 'tech',
    author: { id: 'editorial', name: 'Bali Zero Editorial', avatar: '/images/team/editorial.jpg', role: 'Editorial', isAI: false },
    publishedAt: new Date('2026-01-04'),
    readingTime: 5,
  ...
  },
  {
    ...
    coverImage: '/images/news/bank-screening-clean.jpg',
    category: 'immigration',
    author: { id: 'editorial', name: 'Bali Zero Editorial', avatar: '/images/team/editorial.jpg', role: 'Editorial', isAI: false },
    publishedAt: new Date('2026-01-02'),
    readingTime: 8,
  ...
  },
  {
    ...
    coverImage: '/images/news/immigration-lounge-mall.jpg',
    category: 'immigration',
    author: { id: 'editorial', name: 'Bali Zero Editorial', avatar: '/images/team/editorial.jpg', role: 'Editorial', isAI: false },
    publishedAt: new Date('2026-01-03'),
    readingTime: 5,
  ...
  },
  {
    ...
    category: 'immigration',
    author: { id: 'zantara-ai', name: 'Zantara AI', avatar: '/images/zantara-lotus.png', role: 'AI Research', isAI: true },
  ...
  },
  {
    ...
    category: 'property',
    author: { id: '2', name: 'Property Team', avatar: '/images/team/property.jpg', role: 'Property Specialist', isAI: false },
  ...
  },
  {
    ...
    category: 'immigration',
    author: { id: '1', name: 'Immigration Team', avatar: '/images/team/immigration.jpg', role: 'Immigration Specialist', isAI: false },
